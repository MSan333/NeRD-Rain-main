...
from model_exp2 import MultiscaleNet as myNet
import losses
from losses_exp2 import HierarchicalAdaptiveFreqLoss
...
parser.add_argument('--session', default='Multiscale_H20_Exp2', type=str, help='session name')
...
for epoch in range(start_epoch, num_epochs + 1):
    ...
    for i, data in enumerate(tqdm(train_loader), 0):
        ...
        with autocast(device_type='cuda', dtype=amp_dtype, enabled=use_amp):
            ...
            # HAFL: 分层自适应频域损失（创新点3），作用于最高分辨率输出
    ...
    if SWANLAB_ENABLED:
        swanlab.log({
            ...
            "loss/hafl_loss": epoch_hafl / num_iters,
        }, step=epoch)
